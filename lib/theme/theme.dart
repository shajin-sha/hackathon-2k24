...
import 'package:hackathon/theme/theme_const.dart';
...
class AppTheme {
  static ThemeData get lightMood => ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          ...
          borderRadius: const BorderRadius.all(
              Radius.circular(ThemeConst.defaultBorderRadius - 7)),
        ),
      ...
      popupMenuTheme: PopupMenuThemeData(
        ...
        shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(ThemeConst.defaultBorderRadius)),
      ),
      primaryColor: UiColor.primaryColor,
      textTheme: GoogleFonts.poppinsTextTheme().copyWith(
        displayLarge:
            const TextStyle(fontSize: 72.0, fontWeight: FontWeight.w900),
      ...
      // Card Theme
      cardTheme: CardTheme(
          color: UiColor.cardOnBackgroundColor,
          elevation: ThemeConst.defaultElevation,
          shape: RoundedRectangleBorder(
              borderRadius:
                  BorderRadius.circular(ThemeConst.defaultBorderRadius),
  ...
  static ThemeData get darkThemeData => lightMood.copyWith(
        ...
        textTheme: TextTheme(
          ...
          bodyMedium: const TextStyle(fontSize: 14.0),
          bodySmall:
              TextStyle(fontSize: 12.0, color: UiColor.secondaryTextColor),
        ),
        // Card Theme
        cardTheme: CardTheme(
            color: UiColor.cardOnBackgroundColor,
