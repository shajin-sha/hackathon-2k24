...
class AppTheme {
  static ThemeData get lightMood => ThemeData(
      ...
      popupMenuTheme: PopupMenuThemeData(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(ThemeConst.defaultBorderRadius)),
      ),
      primaryColor: UiColor.primaryColor,
      textTheme: GoogleFonts.poppinsTextTheme().copyWith(
        displayLarge: const TextStyle(fontSize: 72.0, fontWeight: FontWeight.w900),
        titleLarge: const TextStyle(fontSize: 36.0, fontStyle: FontStyle.italic, fontWeight: FontWeight.w700),
